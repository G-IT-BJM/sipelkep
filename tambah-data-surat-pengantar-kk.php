	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Tambah Data Surat Pengantar KK</li>
			</ol>
		</div>
		...
		<div class="row">
            <div class="panel panel-default col-md-10 col-md-offset-1">
                <div class="panel-heading">
                    Tambah Data Surat Pengantar KK
                    ...
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="surat_nikah_meninggal" name="surat_nikah_meninggal" type="file" class="form-control">
                                </div>
                            </div>
