	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Tambah Data Surat Pengantar KTP</li>
			</ol>
		</div>
		...
		<div class="row">
            <div class="panel panel-default col-md-10 col-md-offset-1">
                <div class="panel-heading">
                    Tambah Data Surat Pengantar KTP
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <?php 
                                $query = mysqli_query($conn,"SELECT max(no_surat_pengantar_ktp) AS no_surat FROM tb_surat_pengantar_ktp");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="form-control" onchange="cek_()" id="no_registrasi" name="no_registrasi">
                                        ...
                                        <?php 
                                            $sql = mysqli_query($conn, "SELECT * FROM tb_data_surat AS a INNER JOIN tb_register_pelayanan_surat AS b ON a.kd_surat = b.kd_surat WHERE b.kd_surat = 'KDS-00005' AND b.no_registrasi NOT IN (SELECT no_registrasi FROM tb_surat_pengantar_ktp)");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="ktp_bpk_kandung" name="ktp_bpk_kandung" type="file" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="ktp_ibu_kandung" name="ktp_ibu_kandung" type="file" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" name="simpan_surat_pengantar_ktp" class="btn btn-success btn-md pull-right">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
