	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Tambah Data Surat Pindah</li>
			</ol>
		</div>
            ...
            <div class="panel panel-default col-md-10 col-md-offset-1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <?php 
                                $query = mysqli_query($conn,"SELECT max(no_surat_pindah) AS no_surat FROM tb_surat_pindah");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <select class="form-control" onchange="cek_()" id="no_registrasi" name="no_registrasi">
                                        ...
                                        <?php 
                                            $sql = mysqli_query($conn, "SELECT * FROM tb_data_surat AS a INNER JOIN tb_register_pelayanan_surat AS b ON a.kd_surat = b.kd_surat WHERE b.kd_surat = 'KDS-00001' AND b.no_registrasi NOT IN (SELECT no_registrasi FROM tb_surat_pindah)");
