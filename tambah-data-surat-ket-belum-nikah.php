	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Tambah Data Surat Ket. Belum Nikah</li>
			</ol>
		</div>
		...
		<div class="row">
            <div class="panel panel-default col-md-10 col-md-offset-1">
                <div class="panel-heading">
                    Tambah Data Surat Ket. Belum Nikah
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <?php 
                                $query = mysqli_query($conn,"SELECT max(no_surat_belum_menikah) AS no_surat FROM tb_surat_keterangan_belum_menikah");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="form-control" onchange="cek_()" id="no_registrasi" name="no_registrasi">
                                        ...
                                        <?php 
                                            $sql = mysqli_query($conn, "SELECT * FROM tb_data_surat AS a INNER JOIN tb_register_pelayanan_surat AS b ON a.kd_surat = b.kd_surat WHERE b.kd_surat = 'KDS-00007' AND b.no_registrasi NOT IN (SELECT no_registrasi FROM tb_surat_keterangan_belum_menikah)");
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <a href="surat-ket-belum-nikah.php"><button type="button" class="btn btn-danger btn-md pull-right">Kembali</button></a>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="submit" name="simpan_surat_belum_menikah" class="btn btn-success btn-md pull-right">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
