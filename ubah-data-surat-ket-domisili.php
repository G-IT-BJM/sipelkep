    <?php
        ...
        $id = $_GET['id'];
        $data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tb_surat_keterangan_domisili WHERE id = '$id'"));
	?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Ubah Data Surat Ket Domisili</li>
			</ol>
		</div>
                    ...
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="no_surat" name="no_surat" type="text" value="<?= $data["no_surat_keterangan_domisili"] ?>" placeholder="No Surat" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="nama" name="nama" value="<?= $data["nama"] ?>" type="text" placeholder="Nama" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" name="ubah_surat_ket_domisili" class="btn btn-success btn-md pull-right">Perbarui</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
