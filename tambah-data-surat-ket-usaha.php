            ...
            <div class="panel panel-default col-md-10 col-md-offset-1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <?php 
                                $query = mysqli_query($conn,"SELECT max(no_surat_ket_usaha) AS no_surat FROM tb_surat_keterangan_usaha");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="form-control" onchange="cek_()" id="no_registrasi" name="no_registrasi">
                                        ...
                                        <?php 
                                            $sql = mysqli_query($conn, "SELECT * FROM tb_data_surat AS a INNER JOIN tb_register_pelayanan_surat AS b ON a.kd_surat = b.kd_surat WHERE b.kd_surat = 'KDS-00013' AND b.no_registrasi NOT IN (SELECT no_registrasi FROM tb_surat_keterangan_usaha)");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="ket_domisili" name="ket_domisili" type="file" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" name="simpan_surat_ket_usaha" class="btn btn-success btn-md pull-right">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
