    <?php
        ...
        $id = $_GET['id'];
        $data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tb_surat_keterangan_usaha WHERE id = '$id'"));
	?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Ubah Data Surat Ket. Usaha</li>
			</ol>
		</div>
                    ...
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="no_surat" name="no_surat" type="text" value="<?= $data["no_surat_ket_usaha"] ?>" readonly placeholder="No Surat" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="ktp">KTP Pemohon</label>
                                <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="ket_domisili">Ket Domisili</label>
                                <div class="col-md-5">
                                    <img src="img/<?=$data['fc_surat_ket_domisili']?>" class="img-rounded" width="150" height="150">
                                    <br><br>
                                    <input type="Checkbox" id="chk_ket_domisili" onclick="checkboxs(this.value)" name="ubah_foto[]" value='ket_domisili'> Ceklist Ubah Foto
                                    <br><br>
                                    <input id="ket_domisili" name="ket_domisili" type="file" class="form-control" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <a href="surat-ket-usaha.php"><button type="button" class="btn btn-danger btn-md pull-right">Kembali</button></a>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="submit" name="ubah_surat_ket_usaha" class="btn btn-success btn-md pull-right">Perbarui</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
