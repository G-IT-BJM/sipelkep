	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Tambah Data Surat Izin Tempat Usaha</li>
			</ol>
		</div>
		...
		<div class="row">
            <div class="panel panel-default col-md-10 col-md-offset-1">
                <div class="panel-heading">
                    Tambah Data Surat Izin Tempat Usaha
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="imb" name="imb" type="file" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="surat_permohonan" name="surat_permohonan" type="file" class="form-control">
                                </div>
                            </div>
