    <?php
        ...
        $id = $_GET['id'];
        $data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tb_surat_pengantar_ktp WHERE id = '$id'"));
	?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Transaksi / Ubah Data Surat Pengantar KTP</li>
			</ol>
		</div>
                    ...
                    <form class="form-horizontal" action="proses.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="no_surat" name="no_surat" type="text" placeholder="No Surat" value="<?= $data["no_surat_pengantar_ktp"] ?>" readonly class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="no_registrasi" name="no_registrasi" value="<?= $data["no_registrasi"] ?>" readonly type="text" placeholder="No. Registrasi" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="ktp_bpk_kandung">KTP Bapak Kandung</label>
                                <div class="col-md-5">
                                    <img src="img/<?=$data['fc_ktp_bapak']?>" class="img-rounded" width="150" height="150">
                                    <br><br>
                                    <input type="Checkbox" id="chk_ktp_bpk_kandung" onclick="checkboxs(this.value)" name="ubah_foto[]" value='ktp_bpk_kandung'> Ceklist Ubah Foto
                                    <br><br>
                                    <input id="ktp_bpk_kandung" name="ktp_bpk_kandung" type="file" class="form-control" disabled>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="ktp_ibu_kandung">KTP Ibu Kandung</label>
                                <div class="col-md-5">
                                    <img src="img/<?=$data['fc_ktp_ibu']?>" class="img-rounded" width="150" height="150">
                                    <br><br>
                                    <input type="Checkbox" id="chk_ktp_ibu_kandung" onclick="checkboxs(this.value)" name="ubah_foto[]" value='ktp_ibu_kandung'> Ceklist Ubah Foto
                                    <br><br>
                                    <input id="ktp_ibu_kandung" name="ktp_ibu_kandung" type="file" class="form-control" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" name="ubah_surat_pengantar_ktp" class="btn btn-success btn-md pull-right">Perbarui</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
